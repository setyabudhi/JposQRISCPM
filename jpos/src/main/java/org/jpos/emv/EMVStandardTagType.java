...
public enum EMVStandardTagType implements EMVTagType {
    ...
    APPLICATION_CRYPTOGRAM_0x9F26(0x9F26, "Application Cryptogram",
            ...
            TLVDataFormat.BINARY, new FixedDataLength(8), 0x63, new FixedByteLength(8)),
...
//            new FixedDataLength(6), 0x70, new FixedByteLength(3)),
    ...
    APPLICATION_INTERCHANGE_PROFILE_0x82(0x82, "Application Interchange Profile",
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new FixedDataLength(2), 0x63, new FixedByteLength(2)),
...
//            new VariableByteLength(2, 26)),
    ...
    CRYPTOGRAM_INFORMATION_DATA_0x9F27(0x9F27, "Cryptogram Information Data",
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new FixedDataLength(1), 0x63, new FixedByteLength(1)),
    ...
    ISSUER_APPLICATION_DATA_0x9F10(
            ...
            DataSource.ICC, TLVDataFormat.BINARY, new VariableDataLength(1, 32), 0x63,
...
//            new FixedDataLength(2), 0xA5, new VariableByteLength(2, 8)),
    ...
    UNPREDICTABLE_NUMBER_0x9F37(0x9F37, "Unpredictable Number",
            ...
            DataSource.TERMINAL, TLVDataFormat.BINARY, new FixedDataLength(4), 0x63,
            new FixedByteLength(4)),
    ...
    QRIS_CPM_0x85(
            0x85,
            "QRIS Propertiery",
            "QRIS Propertiery data 85",
            DataSource.ICC, TLVDataFormat.BINARY, new VariableDataLength(2, 5), 0x00,
            new VariableByteLength(2, 5)),
//    QRIS_CPM_0x4F(
//            0x4F,
//            "QRIS AID",
//            "QRIS AID",
//            DataSource.ICC, TLVDataFormat.BINARY, new VariableDataLength(5, 16), 0x61,
//            new VariableByteLength(5, 16)),
//	 QRIS_CPM_0x50(
//            0x50,
//            "QRIS Aplication label",
//            "QRIS Aplication label",
//            DataSource.ICC, TLVDataFormat.ASCII_ALPHA_NUMERIC_SPACE, new VariableDataLength(1, 16), 0x61,
//            new VariableByteLength(1, 16)),
	QRIS_CPM_0x5A(
            0x5A,
            "QRIS Aplication Primary Account",
            "QRIS Aplication Primary Account",
            DataSource.ICC, TLVDataFormat.COMPRESSED_NUMERIC, new VariableDataLength(1, 19), 0x61,
            new VariableByteLength(1, 19)),
	QRIS_CPM_0x5F20(
            0x5F20,
            "QRIS CardHolder Name",
            "QRIS CardHolder Name",
            DataSource.ICC, TLVDataFormat.ASCII_ALPHA_NUMERIC_SPECIAL, new VariableDataLength(2, 26), 0x61,
            new VariableByteLength(2, 26)),
	QRIS_CPM_0x5F2D(
            0x5F2D,
            "QRIS Language Prefrence",
            "QRIS Language Prefrence",
            DataSource.ICC, TLVDataFormat.ASCII_ALPHA_NUMERIC, new VariableDataLength(1, 4), 0x61,
            new VariableByteLength(1, 4)),
	QRIS_CPM_0x5F50(
            0x5F50,
            "QRIS Issuer URL",
            "QRIS Issuer URL",
            DataSource.ICC, TLVDataFormat.ASCII_ALPHA_NUMERIC_SPECIAL, new VariableDataLength(DataLength.DATA_LENGTH_VAR,
                    DataLength.DATA_LENGTH_VAR), 0x61,
            new VariableByteLength(ByteLength.BYTE_LENGTH_VAR, ByteLength.BYTE_LENGTH_VAR)),
	QRIS_CPM_0x9F25(
            0x9F25,
            "QRIS Last Digit PAN",
            "QRIS Last Digit PAN",
            DataSource.ICC, TLVDataFormat.PACKED_NUMERIC, new VariableDataLength(1, 4), 0x61,
            new VariableByteLength(1, 4)),
	TEMPLATE_QRIS_CPM_0x63(
            0x63,
            "QRIS TEMPLATE_QRIS_CPM",
            "QRIS TEMPLATE_QRIS_CPM",
            DataSource.ICC, TLVDataFormat.BINARY, new VariableDataLength(DataLength.DATA_LENGTH_VAR,
                    DataLength.DATA_LENGTH_VAR), 0x61,
            new VariableByteLength(ByteLength.BYTE_LENGTH_VAR, ByteLength.BYTE_LENGTH_VAR)),
	QRIS_CPM_0x9F74(
            ...
            "QRIS ISSUER DATA",
            "QRIS ISSUER DATA",
            DataSource.ICC, TLVDataFormat.ASCII_ALPHA_NUMERIC_SPECIAL, new VariableDataLength(1, 64), 0x63,
			 new VariableByteLength(1, 64));
